...
<div class="profile-bg">
    ...
    <div class="container my-3">
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-lg-6 mx-auto log">
               
            <div class="card">
            <div class="card-header"><h1 class="h3 text-center m-0">Kayıt Ol </h1></div>
               ...
               <div class="card-body">
                   ...
                   <form action="register.php" method="POST" novalidate>
                       ...
                       <input type="submit" name="register" value="Kayıt Ol" class="btn btn-primary   me-3">
                       <a href="login.php" rel="noopener noreferrer" class="btn btn-outline-secondary">Giriş Yap</a>
